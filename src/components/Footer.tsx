...
const centerSocialLinks = [
  { label: 'Phone', href: orgInfo.phoneHref, icon: Phone, external: false },
  { label: 'Email', href: orgInfo.emailHref, icon: Mail, external: false },
  {
    label: 'Location',
  ...
  { label: 'Facebook', href: orgInfo.social.facebook, icon: FacebookIcon, external: true },
  { label: 'LinkedIn', href: orgInfo.social.linkedin, icon: LinkedInIcon, external: true },
  { label: 'YouTube', href: orgInfo.social.youtube, icon: YoutubeIcon, external: true },
  { label: 'TikTok', href: orgInfo.social.tiktok, icon: TikTokIcon, external: true },
];
